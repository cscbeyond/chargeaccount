<template>
  <div class="mine">
    <div class="head">
      <div v-if="havePermission == false" class="img-box">
        <button
          ...
          style="background-image:url(https://chensc.club/static/assets/images/defaultAvatar.jpg);"
          plain="true"
        ></button>
      </div>
    ...
    <div class="mid">
      ...
      <div class="options">
        <div class="option">
          <i class="left iconfont icon-xiazai"></i>
          <span>问题反馈</span>
          <i class="iconfont icon-arrow-right right"></i>
        </div>
      </div>
      <div class="options">
        <div @click='navTo("exchange")' class="option">
          <i class="left iconfont icon-xiazai"></i>
          <span>汇率换算</span>
          <i class="iconfont icon-arrow-right right"></i>
        </div>
  ...
  methods: {
    ...
    getUserInfoFromStorage() {
      ...
      if (userInfo) {
        ...
        this.avatarImgBg =
          "background-image:url(" + this.userInfo.avatarUrl + ");";
      } else {
        this.checkUserInfo();
      }
    },
      ...
      setTimeout(() => {
        wx.getUserInfo({
          success: res => {
            ...
            this.avatarImgBg =
              "background-image:url(" + res.userInfo.avatarUrl + ");";
            wx.hideLoading();
